...
def test_model_scenario(client) -> None:  # type: ignore
    ...
    model_add_schema_2 = {
        "name": model,
        "urls": {
            "g4dn.xlarge": "http://k8s-ingressn-ingressn-c385677c74-b131f1e214e385b7.elb.us-east-1.amazonaws.com:80/server1",
            "g5.xlarge": "http://k8s-ingressn-ingressn-c385677c74-b131f1e214e385b7.elb.us-east-1.amazonaws.com:80/server2",
        },
    }
